...
export const defaultSiteOverrides: SiteOverrides = {
  media: {}, logoText: "remRADAR", logoImage: "/radar-logo.webp", tickerIcon: "✨", heroHeadline: [], heroSubheadline: "", tickerItems: [], featuredSlugs: [], seoTitle: "RADARCharts — Put it on the RADAR", seoDescription: "RADARCharts is a music ecosystem for artists, releases, stories, and the people moving culture forward.", socialImage: "",
};
