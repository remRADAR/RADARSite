          ...
          <FadeIn key={pillar.number}>
            <div className="group brut-border-b relative overflow-hidden">
              ...
              <div className="relative grid min-w-0 grid-cols-[2.25rem_minmax(0,1fr)_minmax(7rem,40%)] items-center gap-x-3 px-4 py-6 md:grid-cols-[8rem_minmax(0,1fr)_28rem] md:gap-8 md:px-8 md:py-10">
                ...
                <p className="min-w-0 text-right font-mono text-[clamp(.6rem,1.5vw,.875rem)] uppercase leading-tight tracking-[.02em] text-muted-foreground group-hover:text-ink md:whitespace-nowrap md:leading-none">{pillar.description}</p>
              </div>
            </div>
          </FadeIn>
        ))}
