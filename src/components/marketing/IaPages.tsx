...
function archiveImageUrl(record: CmsRecord) {
  const explicit = typeof record.imageUrl === "string" && record.imageUrl.trim() ? record.imageUrl : typeof record.featuredImage === "string" && record.featuredImage.trim() ? record.featuredImage : "";
  const richBody = typeof record.bodyHtml === "string" && record.bodyHtml ? record.bodyHtml : typeof record.body === "string" ? record.body : "";
